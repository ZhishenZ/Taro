...
def bkapp(doc):
    ...
    # Create price plot with horizontal-only zoom tools
    ...
    price_plot = figure(
        ...
        width=1000,
        height=400,
        tools=[pan, box_zoom, wheel_zoom, ResetTool(), SaveTool()],
    ...
    # Create volume plot with horizontal-only zoom tools (linked x-axis)
    wheel_zoom_vol = WheelZoomTool(dimensions="width")
    pan_vol = PanTool(dimensions="width")
    box_zoom_vol = BoxZoomTool(dimensions="width")
    ...
    volume_plot = figure(
        ...
        tools=[pan_vol, box_zoom_vol, wheel_zoom_vol, ResetTool(), SaveTool()],
        active_scroll=wheel_zoom_vol
    )
